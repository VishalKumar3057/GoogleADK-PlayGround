...
initial_state = {
    "name": "Vishal Kumar",
    "data":'''
    I am Vishal Kumar, a AI developer with 2 years of experience in Agentic AI.
    I love Cricket, and my favourite player is Imran Khan.
    '''
}

APP_NAME = "Vishal Kumar"
USER_ID = "Vishal"
SESSION_ID = str(uuid.uuid4())       # str(uuid.uuid4())  # Use a unique session ID in production
